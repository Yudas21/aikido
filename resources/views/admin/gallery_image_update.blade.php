            ...
            <section class="content">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Form Update Foto</h3>
                ...
                <div class="card-body">
                     <div class="row">
                        <div class="col-sm-12">  
                              <form action="{{ url('admin/pupdate_image_gallery/'.$data->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <input type="hidden" name="_method" value="PATCH">
                              <div class="form-group">
                                  <label for="image_title" class="col-sm-2 control-label">Judul</label>
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control" name="image_title" value="{{ $data->image_title }}">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-4">
                                      @if($data->image_path!='' || $data->image_path!= NULL)
                                          <img src="{{ url('/storage/foto/'.$data->image_path) }}" class="img-fluid">
                                      @endif
