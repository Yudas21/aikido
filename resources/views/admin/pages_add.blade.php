            ...
            <section class="content">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Form Tambah Page</h3>
                ...
                <div class="card-body">
                     <div class="row">
                        <div class="col-sm-12">  
                              <form action="{{ url('admin/padd_pages') }}" method="post" class="form-horizontal">
                                {{csrf_field()}}
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      <textarea class="form-control" id="froala-editor" name="page_content"></textarea>
